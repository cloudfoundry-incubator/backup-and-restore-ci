...
pushd "bbr-s3-config-validator-artifact"
  ...
  cp bbr-s3-config-validator "$bbr_build/bbr-s3-config-validator-$bbr_version"
  cp bbr-s3-config-validator.sha256 "$bbr_build/bbr-s3-config-validator-$bbr_version.sha256"
popd
